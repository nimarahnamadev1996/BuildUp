...
import {Book,Home,LaptopMinimalCheck,List,ListCheck,Mail,Presentation,Settings,User,} from "lucide-react";
...
const PrivateLayoutSidebar = ({openSidebar,onClose}:{onClose: () => void;openSidebar: boolean}) => {
